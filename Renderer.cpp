...
void Renderer::nanogui_init(GLFWwindow* window)
{
	...
	//object 
	gui_1->addGroup("Object");
	gui_1->addVariable("a", m_animation->a)->setSpinnable(true);
	gui_1->addVariable("b", m_animation->b)->setSpinnable(true);
